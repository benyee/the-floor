...
min_players = 3
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 2)
age_1_cards += [card, ]
min_players = 5
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 2)
age_1_cards += [card, ]
...
min_players = 3
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 3)
age_1_cards += [card, ]
min_players = 7
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 3)
age_1_cards += [card, ]
...
cost_req = [1, ]
rsrc_list = ['BRICK', 'ORE']
token = cards.ResourceToken(rsrc_list)
token_list = [token, ]
min_players = 3
card = cards.BrownResource(name, cost_req,  age, min_players,
                           deepcopy(token_list))
age_1_cards += [card, ]
###
name = "CLAY POOL"
...
name = "GLASSWORKS"
min_players = 3
card = cards.GrayResource(name, age, min_players)
age_1_cards += [card, ]
min_players = 6
card = cards.GrayResource(name, age, min_players)
age_1_cards += [card, ]
...
card = cards.YellowCard(name, cost_req, deepcopy(tech_tree), age, min_players,
                        science_type)
age_1_cards += [card, ]
min_players = 5
card = cards.YellowCard(name, cost_req, deepcopy(tech_tree), age, min_players,
...
tech_tree['next'] = []
min_players = 3
card = cards.RedCard(name, cost_req, deepcopy(tech_tree), age, min_players)
age_1_cards += [card, ]
min_players = 5
card = cards.RedCard(name, cost_req, deepcopy(tech_tree), age, min_players)
age_1_cards += [card, ]
...
min_players = 3
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 5)
age_2_cards += [card, ]
min_players = 7
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 5)
age_2_cards += [card, ]
...
tech_tree['next'] = []
min_players = 3
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 4)
age_2_cards += [card, ]
min_players = 5
card = cards.BlueCard(name, cost_req, deepcopy(tech_tree), age, min_players, 4)
age_2_cards += [card, ]
...
name = "CARAVANSERY"
min_players = 3
card = cards.YellowResource(name, min_players)
age_2_cards += [card, ]
min_players = 5
card = cards.YellowResource(name, min_players)
age_2_cards += [card, ]
